/*
 * M5Stack Tab5 MicroPython Board Configuration
 *
 * This board configuration is specifically optimized for the M5Stack Tab5
 * device with ESP32-P4 microcontroller, 8MB PSRAM, and DSI display.
 */
...
// Using Tab5-specific pin assignments
...
// PSRAM configuration for M5Stack Tab5
#define MICROPY_HW_PSRAM_SIZE               (8 * 1024 * 1024)   // 8MB on Tab5
#define MICROPY_ALLOC_PARSE_CHUNK_INIT      (16)

// Pin definitions for M5Stack Tab5 - ENABLED
#ifndef MICROPY_HW_TAB5_PINS
#define MICROPY_HW_TAB5_PINS                (1)  // Enable Tab5-specific pins
#endif
