...
void create_splash_screen(void) {
    ...
    lv_label_set_text(msg, "Firmware detected! Auto-boot in 5 seconds...\nPress any button to enter Launcher");
...
void update_main_screen(void) {
    // This function can be called to refresh the main screen state
    // For now, we'll recreate the main screen to update firmware status
    if (main_screen) {
